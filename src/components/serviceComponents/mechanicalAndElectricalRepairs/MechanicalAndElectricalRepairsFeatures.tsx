...
import DetailingFeaturesImage from "../../../resources/images/MechanicalAndElectricalRepairsFeaturesImage.jpeg";
                            ...
                            {Config.Features.Features.map((feature, idx) => {
                                return (
                                    ...
                                    >
                                        <img
                                            src={
                                                DetailingServiceBulletPointImage
                                            }
                                            className="w-4 h-4"
                                            alt="Bullet Point"
                                        />
