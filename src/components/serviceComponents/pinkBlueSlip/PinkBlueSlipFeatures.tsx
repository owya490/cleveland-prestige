...
import PinkBlueSlipFeaturesImage from "../../../resources/images/services/pinkblueslip/PinkBlueSlipFeaturesImage.png";
import ServiceBulletPointImage from "../../../resources/images/services/BulletPointImage.png";
import Config from "./PinkBlueSlipConfig.json";
import { motion } from "framer-motion";
import { MotionFade } from "../../../services/animations";

const PinkBlueSlipFeatures = () => {
    const FeaturesImg = (
        <div className="overflow-hidden flex justify-center border-[#9b774e] border-2 ">
            <img
                src={PinkBlueSlipFeaturesImage}
                alt="Features"
...
export default PinkBlueSlipFeatures;
