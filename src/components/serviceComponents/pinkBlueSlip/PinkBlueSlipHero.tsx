...
import PinkBlueSlipHeroImage from "../../../resources/images/services/pinkblueslip/PinkBlueSlipHero.png";
import Config from "./PinkBlueSlipConfig.json";
import { MotionFade } from "../../../services/animations";

const PinkBlueSlipHero = () => {
    const HeroTitle = (
...
export default PinkBlueSlipHero;
